...
mongo.append("conditions", "$in", function (a, b) {
  var aa = arrize(a);return arrize(b).some(function (e) {
    return aa.indexOf(e) >= 0;
  });
});
mongo.append("conditions", "$nin", function (a, b) {
  var aa = arrize(a);return arrize(b).every(function (e) {
    return aa.indexOf(e) < 0;
  });
});
...
mongo.append("conditions", "$or", function (a, b) {
  var _this = this;
  ensure.array(b);return b.reduce(function (p, c) {
...
mongo.append("conditions", "$options", function () {
  return true;
}); // HACK: MongoDB is weird referring to sibling
// $text
